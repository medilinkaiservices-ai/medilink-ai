    ...
    <div className="page-shell">
      <section className="account-hero">
        <div>
          ...
          <p className="muted-copy">
            Submit a clean appointment request for department-based follow-up.
          </p>
        </div>
      ...
      <div className="seller-two-column">
        <form className="auth-card" onSubmit={handleSubmit}>
          ...
          <label>
            Note
            <textarea name="note" rows="4" value={form.note} onChange={handleChange} placeholder="Symptoms or request note" />
          </label>
        ...
        <div className="seller-profile-preview">
          <div className="soft-panel">
            <div className="section-title">Booking help</div>
            <p className="muted-copy">
              Use emergency priority only for urgent situations. For regular OP visits,
              choose normal or priority and mention symptoms clearly.
            </p>
            <div className="account-actions">
              <Link className="header-link" to={`/hospitals/${encodeURIComponent(hospital.id)}`}>
